    /*
        ...
        in the high byte of the index, as follows:
         ...
         neighbour cells.  The two additional bits are used to
         supply the vertical and horizontal phases to the
         rule in case it's interested, eliminating the need for
         texture bits in the map.  If the rule is interested in
         the temporal phase, it can devote a bit of the cell's
         state to it in the conventional manner.  The low order
...
//}
    ...
    function margolus(cells, phyx, phyy, p, lut) {
        //  Fill in old state, vertical and horizontal phase in index
        var idx = (cells[p] | ((rule.evaluator.phase & 3) << 8)) |
