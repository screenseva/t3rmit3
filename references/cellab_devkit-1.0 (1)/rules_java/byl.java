...
class Byl extends ruletable {
    ...
    private final static int[] lut_byl = {
    ...
    private final static int[] lut_byl_v3 = new int[1 << 16];
    ...
    void jcruleModes() {
        setWorld(13);
        setPatternRequest("byl");
        setPaletteRequest("byl");
        setOwnCodeRequest("vonn3");

        for (int i = 0; i < lut_byl.length; i++) {
            ...
            lut_byl_v3[osidx(tC, tN, tE, tS, tW)] =
            lut_byl_v3[osidx(tC, tE, tS, tW, tN)] =
            lut_byl_v3[osidx(tC, tS, tW, tN, tE)] =
            lut_byl_v3[osidx(tC, tW, tN, tE, tS)] = tCp;
        }
    }
    ...
    int jcrule(int oldstate) {
        ...
        return lut_byl_v3[oldstate];
    }
}

public class byl {
    public static void main(String args[]) {
        (new Byl()).generateRuleFile("byl");
    }
}
