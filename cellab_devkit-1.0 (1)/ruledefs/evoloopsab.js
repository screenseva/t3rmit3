    /*
        ...
        This is a special version for the abiogenesis
        experiment. The tranrule table contains 11 entries added
        at the end, marked by a comment, which support
        stochastic input from the vonn4ab evaluator.  Other than
        these additional rules and selecting the vonn4ab
        evaluator, this definition is identical to evoloops.js.

        We use the vonn4ab evaluator, which provides us the
    ...
    */
    ...
    rule.program.tranrule = [
        ...
        //  Additional rules for stochastic input

        0x000112, 0x100001, 0x200112, 0x200142, 0x200172,
                            0x200412, 0x200442, 0x200472,
                            0x200712, 0x200742, 0x200772
    ];
