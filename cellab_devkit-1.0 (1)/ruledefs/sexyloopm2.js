    /*
        ...
        This rule implements the M2 variant of Sexyloop, as
        described by:
        ...
        genetic information.  The M2 differs from M1 in that the
        transfer of genes can occur from the sender to the
        receiver at any point during the receiver's genome. 
        This results in faster interactions and a more diverse
        population of recombined genomes.  See the paper cited
        above for complete details.  Initial patterns are
        compatible with Evoloops.  The rule uses 10 states (0-9)
        and the von Neumann neighborhood.
    ...
    */
    ...
    rule.program.tranrule = [
        ...
        0x126276, 0x200012, 0x200022, 0x200042, 0x200052, 0x200071,
        ...
        0x702150, 0x702221, 0x702320, 0x702626, 0x703120, 0x012431,
        0x012731, 0x012929, 0x015626, 0x016226, 0x016326, 0x019241,
        0x019271, 0x019421, 0x019721, 0x101929, 0x102191, 0x102494,
        0x102797, 0x102921, 0x103429, 0x103729, 0x104924, 0x105626,
        0x106226, 0x107927, 0x109210, 0x111921, 0x112196, 0x112494,
        0x112797, 0x112921, 0x113429, 0x113729, 0x114924, 0x115626,
        0x116226, 0x116929, 0x117927, 0x122466, 0x122766, 0x124291,
        0x124566, 0x127291, 0x127566, 0x200060, 0x200360, 0x200650,
        0x201322, 0x202092, 0x202192, 0x202242, 0x202272, 0x202299,
        0x202922, 0x203192, 0x204322, 0x207322, 0x209122, 0x209422,
        0x209722, 0x212262, 0x212299, 0x212622, 0x222292, 0x222949,
        0x222979, 0x226292, 0x300060, 0x302921, 0x312921, 0x324294,
        0x327297, 0x402130, 0x402921, 0x405626, 0x406226, 0x409120,
        0x409210, 0x416226, 0x500060, 0x500620, 0x500650, 0x600220,
        0x602050, 0x602150, 0x602210, 0x602240, 0x602270, 0x602320,
        0x602450, 0x602750, 0x603210, 0x609922, 0x612192, 0x612250,
        0x612320, 0x619922, 0x623240, 0x623270, 0x624992, 0x627992,
        0x702130, 0x702921, 0x705626, 0x706226, 0x709120, 0x709210,
        0x716226, 0x902129, 0x902131, 0x902299, 0x909129, 0x912129,
    ...
    /*  Define rules concerning state 8
        ...
        below, using states 0-9, the following code fills in
