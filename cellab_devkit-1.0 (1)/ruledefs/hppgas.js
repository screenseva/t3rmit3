    ...
    */
    ...
    function hppgas(oldstate,     nw, n  , ne,
                                  w, self, e,
                                  sw, s  , se) {

        var collision = (CENTER() == OPP()) &&
                        (CW() == CCW()) &&
                        (CENTER() != CW());
        var newSelf = collision ? CW() : OPP();
        ...
        */
        ...
        function OPP() {
            switch (HVPHASE()) {
                case 0:
                    return B(TPHASE()) ? nw : se;
                case 1:
                    return B(TPHASE()) ? ne : sw;
                case 2:
                    return B(TPHASE()) ? sw : ne;
                case 3:
                    return B(TPHASE()) ? se : nw;
            }
        }
